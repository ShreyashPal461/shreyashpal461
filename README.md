...
🔹 **Task Manager (Taskager App UI)**  
→ Designed Android splash screen & UI  
→ Focused on clean UX and modern layout  

🔹 **PHP Web Applications**  
→ Form handling, validation, sessions & cookies  
→ MySQL integration for dynamic data  

🔹 **Data Structures Implementations (C++)**  
→ Queue, Stack, String manipulation problems  
→ Problem-solving with optimized logic  
